...
export const metadata = {
  title: 'Blog | Che Amah Diland Ngwa',
  description: 'Articles on software engineering, distributed systems, Python, and web development.',
}
...
export default async function BlogPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-20 min-h-screen">
      ...
      {posts.length === 0 ? (
        <div className="glassmorphism rounded-2xl p-12 text-center text-text-gray">
          <p className="text-lg mb-2">No blog articles published yet.</p>
          <p className="text-sm">Check back soon for new articles on engineering and architecture.</p>
        </div>
      ) : (
