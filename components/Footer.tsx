        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-6">
              ...
              <Link href="/blog" className="text-text-gray hover:text-primary transition-colors">
                Blog
              </Link>
              <Link href="/resume" className="text-text-gray hover:text-primary transition-colors">
                Resume
              </Link>
