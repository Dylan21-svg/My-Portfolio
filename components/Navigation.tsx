...
import AudioFeedbackToggle from '@/components/AudioFeedbackToggle'
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <AudioFeedbackToggle />
            <Link href="/contact" className="bg-background-medium hover:bg-primary text-white px-5 py-2 rounded-lg transition-colors text-sm font-semibold">
              Let&apos;s talk
            </Link>
          </div>
